      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'var(--bg-card)', padding: '0.5rem 1rem', borderRadius: '50px', border: '1px solid var(--border-color)', marginBottom: '2rem', animation: 'fadeIn 1s ease-out' }}>
            ...
            <span style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', fontWeight: 500 }}>Available for ML & Software Engineering roles</span>
          </div>

          <h1 style={{ fontSize: 'clamp(3rem, 8vw, 5rem)', marginBottom: '1.5rem', animation: 'fadeIn 1s ease-out 0.2s both', lineHeight: 1.1 }}>
            Building <span className="text-gradient">intelligent systems</span> powered by machine learning and scalable web applications.
          </h1>

          <p style={{ fontSize: 'clamp(1.1rem, 3vw, 1.25rem)', color: 'var(--text-secondary)', marginBottom: '3rem', maxWidth: '650px', margin: '0 auto 3rem', animation: 'fadeIn 1s ease-out 0.4s both' }}>
            Machine Learning Engineer and Full Stack Developer. I build end-to-end systems, developing machine learning models and integrating them into robust, deployed backend applications.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6" style={{ marginTop: '5rem', borderTop: '1px solid var(--border-color)', paddingTop: '3rem', animation: 'fadeIn 1s ease-out 0.8s both' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <span style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--text-primary)', fontFamily: 'var(--font-heading)' }}>70+</span>
              <span style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>LeetCode Problems Solved</span>
            </div>
          </div>
